		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Customers To Orders",
									"targetURL": "#comui5srinivascustomerstoorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comui5srinivascustomerstoorders-display": {
								"semanticObject": "comui5srinivascustomerstoorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ui5.srinivas.customerstoorders",
									"url": sap.ui.require.toUrl("com/ui5/srinivas/customerstoorders")
								}
							}
						}
					}
