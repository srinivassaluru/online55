		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "JSON Model",
									"targetURL": "#comsrinivasfeb9ui5jsonmodelexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsrinivasfeb9ui5jsonmodelexample-display": {
								"semanticObject": "comsrinivasfeb9ui5jsonmodelexample",
								"action": "display",
								"description": "JSON Model Example",
								"title": "JSON Model",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.srinivas.feb9.ui5jsonmodelexample",
									"url": sap.ui.require.toUrl("com/srinivas/feb9/ui5jsonmodelexample")
								}
							}
						}
					}
