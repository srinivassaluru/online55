		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsrinivasroutingexample-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsrinivasroutingexample-display": {
								"semanticObject": "comsrinivasroutingexample",
								"action": "display",
								"description": "attachRoutePatternMatched",
								"title": "Routing Example",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.srinivas.routingexample",
									"url": sap.ui.require.toUrl("com/srinivas/routingexample")
								}
							}
						}
					}
