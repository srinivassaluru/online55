		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "First Odata Example",
									"targetURL": "#comsrinivassdodataexamplenorthwind-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsrinivassdodataexamplenorthwind-display": {
								"semanticObject": "comsrinivassdodataexamplenorthwind",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.srinivas.sd.odataexamplenorthwind",
									"url": sap.ui.require.toUrl("com/srinivas/sd/odataexamplenorthwind")
								}
							}
						}
					}
