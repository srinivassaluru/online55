		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsaphrleaveapprove-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaphrleaveapprove-display": {
								"semanticObject": "comsaphrleaveapprove",
								"action": "display",
								"description": "Leave Approve / Reject",
								"title": "Leave Approve / Reject",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.hr.leaveapprove",
									"url": sap.ui.require.toUrl("com/sap/hr/leaveapprove")
								}
							}
						}
					}
